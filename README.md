...
- [PyAlgoTrade](http://gbeced.github.io/pyalgotrade/docs/v0.20/html/index.html) is an event-driven algorithmic trading Python library which supports back-testing, live-feed paper trading and real-time trading on Bitstamp.
